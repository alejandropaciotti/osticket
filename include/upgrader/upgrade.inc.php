...
?>
<h2><?php echo __('osTicket Upgrade');?></h2>
<div id="upgrader">
    <div id="main">
            <div id="intro">
             <p><?php echo __('Thank you for taking the time to upgrade your osTicket intallation!');?></p>
             <p><?php echo __("Please don't cancel or close the browser, any errors at this stage will be fatal.");?></p>
            </div>
            <h2 id="task"><?php echo $action ?></h2>
            <p><?php echo __('The upgrade wizard will now attempt to upgrade your database and core settings!');?></p>
            <ul>
                <li><?php echo __('Database enhancements');?></li>
                <li><?php echo __('New and updated features');?></li>
                <li><?php echo __('Enhance settings and security');?></li>
            </ul>
            <div id="bar">
