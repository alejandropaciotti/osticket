...
<div id="upgrader">
    ...
    <div id="main">
            ...
            <?php echo __('We hightly recommend that you follow the steps below.');?>
            <ul>
                <li><?php echo __("Backup the current database, if you haven't done so already.");?></li>
    ...
    <div id="sidebar">
            ...
            <p>1. <?php echo __('Remember to backup your osTicket database');?></p>
