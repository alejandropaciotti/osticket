...
<form action="canned.php?<?php echo $qstr; ?>" method="post" id="save" enctype="multipart/form-data">
 ...
 <h2><?php echo __('Canned Response')?></h2>
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <input type="radio" name="isenabled" value="1" <?php echo $info['isenabled']?'checked="checked"':''; ?>><?php echo __('Active');?>
        ...
        <tr>
            <td colspan=2>
                ...
                <br><br><div><b><?php echo __('Canned Response');?></b> <font class="error">*&nbsp;<?php echo $errors['response']; ?></font>
                    &nbsp;&nbsp;&nbsp;(<a class="tip" href="ticket_variables"><?php echo __('Supported Variables');?></a>)</div>
                <textarea name="response" cols="21" rows="12" style="width: 80%;"><?php echo $info['response']; ?></textarea>
                <br><br><div><b><?php echo __('Canned Attachments');?></b> (<?php echo __('optional');?>) <font class="error">&nbsp;<?php echo $errors['files']; ?></font></div>
                <?php
