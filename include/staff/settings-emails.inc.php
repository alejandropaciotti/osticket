    ...
    <thead>
        <tr>
            <th colspan="2">
                ...
                <em><?php echo __('Note that some of the global settings can be overwritten at department/email level.');?></em>
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;<em><?php echo __("(System administrator's email)");?></em> 
            </td>
        </tr>
        <tr><th colspan=2><em><strong><?php echo __('Incoming Emails');?></strong>: <?php echo __('For mail fetcher (polling) to work you must set an external cron job or enable auto-cron polling');?></em></th>
        <tr>
            <td width="180"><?php echo __('Email Polling');?>:</td>
            <td><input type="checkbox" name="enable_mail_polling" value=1 <?php echo $config['enable_mail_polling']? 'checked="checked"': ''; ?>  > <?php echo __('Enable POP/IMAP polling');?>
                 &nbsp;&nbsp;
                 <input type="checkbox" name="enable_auto_cron" <?php echo $config['enable_auto_cron']?'checked="checked"':''; ?>>
                 <?php echo __('Poll on auto-cron');?> <em><?php echo __('(Poll based on staff activity - NOT recommended)');?></em>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <em><?php echo __('(depends on the reply separator tag set below)');?></em>
        ...
        <tr><td width="180"><?php echo __('Default Outgoing Email');?>:</td>
            <td>
