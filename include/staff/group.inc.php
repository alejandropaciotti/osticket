    ...
    <tbody>
        ...
        <tr><td><?php echo __('Can <b>Create</b> Tickets');?></td>
            <td>
                ...
                &nbsp;&nbsp;<i><?php echo __('Ability to open tickets on behalf of clients.');?></i>
            </td>
        </tr>
        ...
        <tr>
            <th colspan="2">
                <em><strong><?php echo __('Department Access');?></strong>: <?php echo __('Check all departments the group members are allowed to access.');?>&nbsp;&nbsp;&nbsp;<a id="selectAll" href="#deptckb"><?php echo __('Select All');?></a>&nbsp;&nbsp;<a id="selectNone" href="#deptckb"><?php echo __('Select None');?></a>&nbsp;&nbsp;</em>
            </th>
        </tr>
        <?php
