...
<form action="templates.php?<?php echo $qstr; ?>" method="post" id="save">
 ...
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr>
            <th colspan="2">
                <em><strong><?php echo __('Template Messages');?></strong>: <?php echo __('Click on the message to edit.');?>&nbsp;
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['tpl_id']; ?></span>
                 <em>(<?php echo __('select an existing template to copy and edit it thereafter');?>)</em>
            </td>
        </tr>
        <?php } ?>
        <tr>
