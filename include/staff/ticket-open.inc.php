    ...
    <tbody>
        <tr>
            ...
            if($cfg->notifyONNewStaffTicket()) { ?>
               &nbsp;&nbsp;&nbsp;
               <input type="checkbox" name="alertuser" <?php echo (!$errors || $info['alertuser'])? 'checked="checked"': ''; ?>><?php echo __('Send alert to user.');?>
            <?php 
             } ?>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo __('Ext');?> <input type="text" size="6" name="phone_ext" id="phone_ext" value="<?php echo $info['phone_ext']; ?>">
        ...
        <tr>
            <th colspan="2">
                <em><strong><?php echo __('Issue');?></strong>: <?php echo __('The user will be able to see the issue summary below and any associated responses.');?></em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
                <div>
                    <em><strong><?php echo __('Subject');?></strong>: <?php echo __('Issue summary');?> </em> &nbsp;<font class="error">*&nbsp;<?php echo $errors['subject']; ?></font><br>
                    <input type="text" name="subject" size="60" value="<?php echo $info['subject']; ?>">
                </div>
                <div><em><strong><?php echo __('Issue');?></strong>: <?php echo __('Details on the reason(s) for opening the ticket.');?></em> <font class="error">*&nbsp;<?php echo $errors['issue']; ?></font></div>
        ...
        <tr>
            <th colspan="2">
                <em><strong><?php echo __('Internal Note');?></strong>: <?php echo __('Optional internal note (recommended on assignment)');?> <font class="error">&nbsp;<?php echo $errors['note']; ?></font></em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
...
<p style="padding-left:250px;">
    <input type="submit" name="submit" value="<?php echo __('Create');?>">
    <input type="reset"  name="reset"  value="<?php echo __('Reset');?>">
    <input type="button" name="cancel" value="<?php echo __('Cancel');?>" onclick='window.location.href="tickets.php"'>
</p>
</form>
