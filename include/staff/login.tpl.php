...
<head>
    ...
    <title><?php echo __('osTicket:: SCP Login');?></title>
...
<div id="loginBox">
    ...
    <form action="login.php" method="post">
        ...
        <fieldset>
            <input type="text" name="username" id="name" value="<?php echo $info['username']; ?>" placeholder="<?php echo __('username');?>" autocorrect="off" autocapitalize="off">
